...
urlpatterns = [
    ...
    path('loc/<pk>/kakutei_del/', views.KakuteiDelete.as_view(), name='kakutei_del'),
    ...
    path('loc/kakutei_list', views.KakuteiList.as_view(), name='kakutei_list'),
    ...
    path('loc/down_pick/<int:pick_pk>', views.down_pick, name='down_pick'),
    ...
    path('<int:pk>/kakutei_update/', views.KakuteiUpdate.as_view(), name='kakutei_update'),
    path('kakutei_create/', views.KakuteiCreate.as_view(), name='kakutei_create'),
#    path('adds_export/', views.input_case, name='down_input'),
    path('loc/input_list', views.InputList.as_view(), name='input_list'),
    path('loc/input_case/', views.input_case, name='input_case'),
